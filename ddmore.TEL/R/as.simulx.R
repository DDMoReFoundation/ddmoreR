...
#' as.simulx
#'
#' Converts an MDL file into appropriate inputs for use with the mlxR function simulx
#'
#' @param x An MDL file
#' @return A list containing the converted PharmML file, parameters, administration schedule,
#'         group (trial design arms), and sampling schedules. Ready for  use with simulx.
#' 
#' @author Mike K Smith
#' 
#' @seealso \code{simulx}
