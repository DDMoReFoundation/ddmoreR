...
parsed <- getMDLObjects("ex_model7_prolactin_04Jun2014_OAM.mdl")

# Look at the names of the parsed objects
names(parsed)

# We can now extact the objects from the list manually:
...
dat <- getDataObjects("ex_model7_prolactin_04Jun2014_OAM.mdl")
