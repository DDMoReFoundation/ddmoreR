...
test_that("Test getPopulatedSlots returns a character vector of slot names.", {
  ...
  expect_equal(output, 
    expected = c("RawResults", "Estimation::PopulationEstimates::MLE", 
        ...
        "Estimation::Residuals::ResidualTable", "Estimation::Predictions", 
...
test_that("Test getPopulatedSlots returns x for Use Case 11 output.", {
